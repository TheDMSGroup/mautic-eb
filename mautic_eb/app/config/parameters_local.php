...
$parameters = [
    ...
    'db_host'           => getenv('DB_HOST') ?: $parameters['db_host'] ?? 'mautic-eb-prod-copy-for-dev.cmvytjeebczc.us-east-2.rds.amazonaws.com',
    'db_host_ro'        => getenv('DB_HOST_RO') ?: null,
    'db_port'           => getenv('DB_PORT') ?: $parameters['db_port'] ?? '3306',
    'db_name'           => getenv('DB_NAME') ?: $parameters['db_name'] ?? 'mautic_eb',
    'db_user'           => getenv('DB_USER') ?: $parameters['db_user'] ?? 'mautic_eb',
    'db_password'       => getenv('DB_PASSWD') ?: $parameters['db_password'] ?? 'akldfjsalkj398fofoood',
