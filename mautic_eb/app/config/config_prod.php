...
// Allow more parallel file imports.
// $container->setParameter('mautic.parallel_import_limit', 12);
...
$container->setParameter('mautic.famework.csrf_protection', !empty(getenv('CSRF')) ? boolval(getenv('CSRF')) : true);
